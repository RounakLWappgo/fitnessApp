...
const FirstRoute = () => (
  <View style={[styles.scene, { backgroundColor: '#eee' }]}>
      <Text style={{fontSize:30, fontWeight:"bold", marginLeft:20, marginBottom:20, marginTop:30}}>Most Popular Trainings</Text>
      <List horizontal={true}/>
      <Text style={{fontSize:30, fontWeight:"bold", marginLeft:20, marginBottom:20, marginTop:30}}>Just For You</Text>
      <List horizontal={true}/>
  </View>
);
