...
export default StatsCard = (props) => {
  return <View style={{backgroundColor:"white", width:175, marginHorizontal:10, marginVertical:10, borderRadius:30}}>
      ...
      <View style={{justifyContent:"center", alignItems:"center"}}>
          {props.stats? props.stats:<View style={{width:130, height:135}}>
          </View> }
      </View>
